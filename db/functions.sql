...
-- Apply this in the Supabase SQL editor after db/postgres.sql.
--
-- Each function is SECURITY INVOKER (the default), so Row Level Security still
-- applies and a caller only ever aggregates their own rows.
