# French Dictionary — A2 to B1

Everything in one place: **A2 core vocabulary**, **B1 vocabulary**, **occupations**, and the **supplement** (prepositions, idioms, register). Around 1,400 entries, covering the ~2,500–3,000 word target for B1.

**Two rules throughout:**
1. **Learn nouns with their article** — `une table`, not `table`. Gender is much harder to add later.
2. **Sections A1–A2 and the connectors in B1 matter most.** Function words, verbs and connectors appear in every sentence; themed nouns can wait.
...
| mon, ton, son / ma, ta, sa | my, your, his-her |
| et | and |
| ou | or |
| mais | but |
| parce que | because |
...
**The big irregulars — learn these thoroughly**
...
| ouvrir / fermer | to open / to close |
| dormir | to sleep |
| se lever | to get up |
...
| un copain / une copine | a friend, boyfriend/girlfriend |
...
| l'heure | hour, time |
| la minute / la seconde | minute / second |
...
| l'automne / l'hiver | autumn / winter |
| tôt / tard | early / late |
| bientôt | soon |
...
| French | English |
|---|---|
| zéro, un, deux, trois | 0, 1, 2, 3 |
| quatre, cinq, six | 4, 5, 6 |
| sept, huit, neuf, dix | 7, 8, 9, 10 |
| onze, douze, treize | 11, 12, 13 |
| quatorze, quinze, seize | 14, 15, 16 |
| dix-sept, dix-huit, dix-neuf | 17, 18, 19 |
| vingt, trente, quarante | 20, 30, 40 |
| cinquante, soixante | 50, 60 |
| soixante-dix, quatre-vingts | 70, 80 |
| quatre-vingt-dix, cent, mille | 90, 100, 1000 |
| premier / première | first |
| deuxième, troisième | second, third |
...
| un verre | a glass |
| une tasse | a cup |
| une fourchette / un couteau | fork / knife |
| une cuillère | spoon |
...
| le stylo | pen |
| l'examen | exam |
| la question / la réponse | question / answer |
| le devoir | homework |

---

## A9. Travel and directions
...
| la caisse | checkout |
| la taille | size |
| soldes / réduction | sales / discount |
...
## A14. Countries, nationalities and languages

Nationalities are adjectives: lowercase when describing (`il est français`), capitalised as a noun for a person (`un Français`). Languages are always lowercase and masculine (`le français`).

| Country | Nationality (m / f) | Language |
|---|---|---|
| la France | français / française | le français |
| l'Angleterre | anglais / anglaise | l'anglais |
| le Royaume-Uni | britannique | l'anglais |
| l'Irlande | irlandais / irlandaise | l'anglais |
| l'Écosse | écossais / écossaise | l'anglais |
...
| la Belgique | belge | le français / le néerlandais |
| la Suisse | suisse | le français / l'allemand |
| les Pays-Bas | néerlandais / néerlandaise | le néerlandais |
| la Grèce | grec / grecque | le grec |
| la Pologne | polonais / polonaise | le polonais |
| la Russie | russe | le russe |
| les États-Unis | américain / américaine | l'anglais |
| le Canada | canadien / canadienne | l'anglais / le français |
...
| l'Inde | indien / indienne | l'hindi / l'anglais |
| la Corée | coréen / coréenne | le coréen |
| l'Australie | australien / australienne | l'anglais |
| le Maroc | marocain / marocaine | l'arabe |
| l'Algérie | algérien / algérienne | l'arabe |
| la Tunisie | tunisien / tunisienne | l'arabe |
| le Sénégal | sénégalais / sénégalaise | le français |
| le Nigeria | nigérian / nigériane | l'anglais |
| l'Afrique du Sud | sud-africain / sud-africaine | l'anglais |
| l'Égypte | égyptien / égyptienne | l'arabe |

**Prepositions with places**

| Rule | Example |
|---|---|
| Feminine country → **en** | `en France`, `en Espagne`, `en Italie` |
| Masculine country → **au** | `au Portugal`, `au Canada`, `au Japon` |
| Plural country → **aux** | `aux États-Unis`, `aux Pays-Bas` |
| City → **à** | `à Paris`, `à Londres`, `à Lagos` |
| Coming from (f) → **de** | `je viens de France` |
| Coming from (m) → **du** | `je viens du Portugal` |
...
| l'île | island |
| la frontière | border |
| le nord / le sud | north / south |
| l'est / l'ouest | east / west |
...
| l'immeuble | apartment block |

---

## A16. Hobbies and free time

| French | English |
|---|---|
| le loisir | leisure, hobby |
| le sport | sport |
...
| prêt | ready |
| libre / occupé | free / busy |
| même | same |
| autre | other |
| tout | all, everything |

**Colours:** blanc, noir, rouge, bleu, vert, jaune, orange, rose, gris, marron

---

## A20. Everyday phrases
...
# PART B — B1 VOCABULARY

A2 is about surviving concrete situations. B1 is about **opinions, abstraction and connected speech**. Sections B1–B3 change how you sound far more than any themed noun list — do those first.

---

## B1. Connectors — the biggest single win

A2 speech is short sentences. B1 links them.
...
| comme | as, since (at start of sentence) |
| grâce à | thanks to |
...
| du coup | so, as a result (informal, very common) |
...
| en revanche | on the other hand (more formal) |
| alors que | whereas |
...
| au fur et à mesure | gradually, as you go |
...
| sinon | otherwise |
| sauf si | unless |
| pourvu que (+ subj) | as long as |

---

## B2. Opinion, agreement and doubt
...
| au fond | deep down, fundamentally |
| j'avoue que | I admit that |
| cela dit | that said |
...
## B3. Abstract and precise verbs

A2 gives you *dire, faire, penser*. B1 wants the specific one.
...
| se dérouler | to unfold, take place |
...
| la carrière | career |
| le contrat | contract |
| le CDI / le CDD | permanent / fixed-term contract |
| le stage | internship |
...
| l'employeur / l'employé | employer / employee |
| l'équipe | team |
| le service | department |
| la responsabilité | responsibility |
| la tâche | task |
| le projet | project |
| le délai | deadline |
| l'horaire | schedule |
| le congé | leave, time off |
| la retraite | retirement |
| la promotion | promotion |
| licencier | to dismiss, lay off |
...
| la fac | uni (informal) |
| la licence / le master | bachelor's / master's |
| la matière | subject |
| la note | mark, grade |
| le bulletin | report card |
| la rentrée | back-to-school |
| le semestre | semester |
| la recherche | research |
| le mémoire / la thèse | dissertation / thesis |
| la conférence | lecture |
| l'exposé | presentation |
| le résumé | summary |
| la rédaction | essay writing |
| le brouillon | draft |
| réviser | to revise |
| s'inscrire | to enrol |
...
## B6. Money and society

| French | English |
|---|---|
| le budget | budget |
| les frais | costs, expenses |
...
## B7. Environment and current affairs
...
| grossir / maigrir | to gain / lose weight |
| fumer | to smoke |
| arrêter de | to stop doing |

---

## B9. Feelings and character
...
| puissant | powerful |
| profond | deep |
| léger / lourd | light / heavy |
| doux | soft, gentle, mild |
| dur | hard, tough |

---

## B11. Time, frequency and sequence
...
| annuel | yearly |
| la durée | duration |
| le début / la fin | beginning / end |
| l'étape | stage, step |

---

## B12. Quantity and comparison
...
| en partie | partly |
| la moitié | half |
| le tiers / le quart | a third / a quarter |
...
| l'aller-retour | return ticket |
| le trajet | journey |
| l'itinéraire | route |
| la douane | customs |
| le passeport | passport |
| le visa | visa |
| l'étranger | abroad, foreigner |
| à l'étranger | abroad |
| le guide | guide |
...
Occupations come up constantly: introductions, describing family, talking about plans.


## C1. The two grammar points that matter

**1. No article after `être`.**
`Je suis médecin.` — NOT `je suis un médecin`.
The article comes back if you add an adjective: `C'est un bon médecin.`

**2. Feminine forms follow patterns.**

| Ending | Feminine | Example |
|---|---|---|
| `-eur` | `-euse` | vendeur → vendeuse |
| `-teur` | `-trice` | acteur → actrice |
| `-ier` | `-ière` | infirmier → infirmière |
| `-ien` | `-ienne` | pharmacien → pharmacienne |
| `-e` | unchanged | un/une journaliste |
| consonant | add `-e` | avocat → avocate |

Some traditionally had no feminine form (`médecin`, `professeur`, `écrivain`); modern usage increasingly adds one (`une médecin`, `une professeure`, `une écrivaine`). Both are accepted.

---

## C2. Health and public service

| French | English |
|---|---|
| le médecin | doctor |
| le/la généraliste | GP |
...
| le facteur / la factrice | postal worker |
| le/la fonctionnaire | civil servant |
| l'assistant social | social worker |

---

## C3. Trades and manual work

| French | English |
|---|---|
| l'ouvrier / l'ouvrière | manual worker |
| l'artisan | craftsperson |
| le plombier | plumber |
...
| le chauffeur | driver |
| le conducteur / la conductrice | driver (train, bus) |
| le livreur / la livreuse | delivery driver |
...
| le banquier / la banquière | banker |
| le/la secrétaire | secretary |
| l'assistant / l'assistante | assistant |
| le directeur / la directrice | director, manager |
| le cadre | executive, manager |
| le/la responsable | person in charge |
| le commercial / la commerciale | sales rep |
| le/la consultant(e) | consultant |
| l'informaticien / l'informaticienne | IT specialist |
| le développeur / la développeuse | developer |
...
| le/la designer | designer |
| le/la bibliothécaire | librarian |

---

## C7. Talking about work

| French | English |
|---|---|
| Qu'est-ce que vous faites dans la vie ? | What do you do for a living? |
| Qu'est-ce que tu fais comme travail ? | What's your job? (informal) |
| Je suis + job | `Je suis ingénieur.` |
| Je travaille comme... | I work as... |
| Je travaille dans... | I work in... (a sector) |
| Je travaille pour... | I work for... (a company) |
...
| indépendant / à son compte | self-employed |
...
Seven areas that change how natural you sound. D1, D2, D6 and D7 matter most: they're where learners with good vocabulary still sound wrong.


---

## D1. Verbs with prepositions

You already know these verbs. Using the wrong preposition is the most visible intermediate error, because the sentence is otherwise correct.
...
| penser à | to think about (remember) |
...
### Verb + infinitive (NO preposition)
| French | English |
|---|---|
| vouloir, pouvoir, devoir | want, can, must |
| aller, venir | going to, come to |
| savoir | to know how to |
| aimer, préférer, détester | like, prefer, hate |
| espérer | to hope |
| falloir (il faut) | to be necessary |
| laisser, faire | to let, to make |
...
**No preposition in French, but one in English** — a classic trap:
`chercher` (look **for**), `écouter` (listen **to**), `regarder` (look **at**), `attendre` (wait **for**), `demander` (ask **for**), `payer` (pay **for**).

---

## D2. Backwards verbs

These work opposite to English. The thing is the subject, the person is the object.

| French | Literally | Means |
|---|---|---|
| Ça me plaît | it pleases me | I like it |
| Ce film m'a plu | the film pleased me | I liked the film |
| Tu me manques | you are missing to me | **I miss you** |
| Il me faut du temps | it is necessary to me | I need time |
| Ça m'intéresse | it interests me | I'm interested |
| Ça m'ennuie | it bores me | I'm bored by it |
| Ça me convient | it suits me | that works for me |
| Il me reste 10 euros | there remains to me | I have 10 euros left |
| Ça m'arrive | it happens to me | it happens to me sometimes |
| Il s'agit de | it is a question of | it's about |

**`Tu me manques` is the one people get backwards constantly.** To say "I miss you," the person you miss is the *subject*.

---

## D3. Physical description

| French | English |
|---|---|
| avoir l'air (+ adj) | to look, seem |
| ressembler à | to look like |
| grand / petit | tall / short |
| mince | slim |
| maigre | thin (negative) |
| gros | fat |
| costaud | well-built |
| musclé | muscular |
...
| raides / bouclés / frisés | straight / wavy / curly |
| longs / courts | long / short |
| chauve | bald |
| la barbe / la moustache | beard / moustache |
| les yeux bleus / verts / marron | blue / green / brown eyes |
| porter des lunettes | to wear glasses |
| la peau | skin |
| la taille | height, size |
| le poids | weight |
| une cicatrice | a scar |
| un tatouage | a tattoo |

`Il a les yeux bleus` — use **avoir** + definite article, not `ses yeux sont bleus`.

---

## D4. Materials, shapes and textures
...
| le fer | iron |
| l'acier | steel |
| l'or / l'argent | gold / silver |
| le papier / le carton | paper / cardboard |
| le tissu | fabric |
| le coton | cotton |
| la laine | wool |
| le cuir | leather |
...
| la pierre | stone |
| le béton | concrete |
| **en** + material | made of (`une table en bois`) |
| rond | round |
| carré | square |
...
| ovale | oval |
| plat | flat |
| épais / fin | thick / thin |
| pointu | pointed |
| lisse | smooth |
| rugueux | rough |
| mou / dur | soft / hard |
| solide / fragile | sturdy / fragile |

---

## D5. Numbers in practice

| Situation | French |
|---|---|
| Price | `12,50 €` → *douze euros cinquante* |
| Decimal comma | `3,5` → *trois virgule cinq* |
| Fractions | `1/2` *un demi*, `1/3` *un tiers*, `1/4` *un quart*, `3/4` *trois quarts* |
| Percentage | `20 %` → *vingt pour cent* |
| Date | `le 3 mai 2026` → *le trois mai* (no "third") |
| First of month | `le 1er` → *le premier* (only ordinal used) |
| Year | `2026` → *deux mille vingt-six* |
| Phone | read in pairs: `06 12 34 56 78` |
| Time (12h) | *il est trois heures et quart / et demie / moins le quart* |
| Time (24h) | *quinze heures trente* |
| Approximate | *une dizaine* (~10), *une centaine* (~100), *un millier* (~1000) |
| Ordinals | *premier, deuxième, troisième... vingtième* |

**Careful:** `quatre-vingts` has an `-s`, but `quatre-vingt-un` does not. `cent` follows the same rule.

---

## D6. Politeness and register

The `tu` / `vous` choice is a real social judgement, not a formality.

| Use **tu** | Use **vous** |
|---|---|
| Friends, family, children | Strangers, older people |
| Colleagues your age | Clients, officials, shopkeepers |
| Fellow students | Anyone in authority |
| Animals | Groups (always, even friends) |

When unsure, **use `vous`** and wait — `on peut se tutoyer ?` is how someone offers the switch.
...
| C'est faux. | **Je ne suis pas sûr que...** |
| Vous avez tort. | **Je ne vois pas les choses comme ça.** |

| French | English |
|---|---|
| Excusez-moi de vous déranger | Sorry to bother you |
| Ça vous dérange si...? | Do you mind if...? |
| Est-ce que je pourrais...? | Could I possibly...? |
| Si ça ne vous dérange pas | If you don't mind |
| Ce serait possible de...? | Would it be possible to...? |
| Je vous en prie | Please do / You're welcome |
| Avec plaisir | With pleasure |
| Désolé de vous déranger | Sorry to disturb you |
| Bien à vous / Cordialement | Regards (email sign-off) |

**Register warning:** `Quoi ?` is blunt — use `Pardon ?` or `Comment ?`. And `Qu'est-ce que tu veux ?` sounds aggressive; `Qu'est-ce que je peux faire pour vous ?` is the polite form.

---

## D7. Everyday idioms

Very common in speech, and largely opaque if you haven't met them.

| French | Literally | Means |
|---|---|---|
| ça marche | it walks | that works / OK |
| ça roule | it rolls | all good (informal) |
| ça y est | it's there | that's it, done |
| ça craint | it fears | that sucks |
| n'importe quoi | no matter what | nonsense, rubbish |
| j'en ai marre | I have enough of it | I'm fed up |
| j'en ai ras-le-bol | — | I've had it up to here |
| avoir le cafard | to have the cockroach | to feel down |
| avoir la pêche / la patate | to have the peach | to feel great |
...
| avoir un coup de foudre | a lightning strike | love at first sight |
| ce n'est pas la mer à boire | it's not the sea to drink | it's not that hard |
| revenons à nos moutons | back to our sheep | back to the point |
| mettre les pieds dans le plat | feet in the dish | to put one's foot in it |
| être à l'aise | to be at ease | to be comfortable |
| avoir du mal à | to have difficulty | to struggle to |
| ça vaut le coup | it's worth the blow | it's worth it |
| du coup | — | so, as a result |
| au fait | — | by the way |
| bref | — | anyway, in short |
| ça dépend | — | it depends |
| tant pis | so much worse | never mind, too bad |
| tant mieux | so much better | all the better |
| de rien | of nothing | you're welcome |
| n'importe quand / où | — | any time / anywhere |
| petit à petit | little by little | gradually |
| tout de suite | — | right away |
| par hasard | by chance | by any chance |
| en gros | roughly | broadly speaking |
| carrément | squarely | totally, absolutely |
...
- **Present tense** — the big irregulars plus `-er / -ir / -re` patterns.
- **Passé composé** — past tense, with the `avoir` vs `être` split.
- **Imperfect vs passé composé** — background/habit vs completed action. The core of telling any story.
- **Plus-que-parfait** — for events before other past events.
- **Futur proche** (`je vais + inf`) and **future simple**.
- **Conditional** — `je voudrais`, `on pourrait`, `si j'avais... je ferais...`
- **Subjunctive** — after `il faut que`, `bien que`, `pour que`, `avant que`, `je veux que`, and verbs of emotion or doubt.
- **Negation** (`ne... pas`, `ne... jamais`, `ne... rien`, `ne... personne`) and question forms (`est-ce que`, intonation, inversion).
- **Adjective agreement and placement.**
- **Partitive articles** (`du, de la, des`) — trips people up constantly with food.
- **Pronouns** — `le, la, lui, y, en` and relative `qui, que, dont, où`.
- **Passive voice** and **reported speech** (`il a dit que...`).

---

# FAUX AMIS — the full set

Words that look English but aren't.

| French | Actually means | NOT |
|---|---|---|
| actuellement | currently | actually |
| éventuellement | possibly | eventually |
| finalement | in the end | finally (order) |
| sensible | sensitive | sensible |
| librairie | bookshop | library |
| assister à | to attend | to assist |
| attendre | to wait | to attend |
| rester | to stay | to rest |
| journée | day | journey |
| monnaie | change (coins) | money |
| passer un examen | to sit an exam | to pass |
| demander | to ask | to demand |
| ignorer | to not know | to ignore |
| prétendre | to claim | to pretend |
| supporter | to bear, tolerate | to support (a cause) |
| réaliser | to carry out | to realise (mentally) |
| formidable | wonderful | formidable |
| large | wide | large |
| gentil | kind | gentle |
...
| achever | to complete | to achieve |
| blesser | to injure | to bless |
